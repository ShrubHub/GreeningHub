...
pallet3 <- c("#cc0000", "#ffe000", "#ffc900", "#ffbd00", "#ff9b00", "#009933", "#3366ff", "#9966ff")
bands$Satellite <- factor(bands$Satellite, levels = c("AVHRR", "Landsat-MSS", "Landsat-TM", "Landsat-ETM+", "Landsat-OLI-TIRS", "MODIS", "Sentinel-2A", "Sentinel-2B"))
...
ggsave("plots/band_widths.png", plot = plot, width = 12, height = 4, units = "in", dpi = 300)
